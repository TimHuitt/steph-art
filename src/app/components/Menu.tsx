...
const Menu: React.FC = () => {
  ...
  return (
    <>
      <div className="sticky top-0 h-14 flex justify-center items-center text-xl overflow-hidden z-50">
      ...
      <div className="sticky top-0 w-full h-14 flex -mt-14 mr-8 justify-end items-center text-xl overflow-hidden z-50">
